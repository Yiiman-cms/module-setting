...
use YiiMan\Setting\assets\AdminBgImagesAssets;
use YiiMan\Setting\widgets\ImageField;
use YiiMan\Setting\widgets\ImageSelectWidget;
use YiiMan\Setting\widgets\SwitchField;
$images=AdminBgImagesAssets::register($this);
?>
            ...
            <div class="row" style="margin-top: 20px">
                <div class="col-md-12">
                    ...
                    for ($i = 1; $i < $itemsCount + 1; $i++) {
                        $items[$images->baseUrl.'/'.$i.'.jpg'] = $images->baseUrl.'/'.$i.'.jpg';
                    }
                    ?>
